...
{
    return (obj1.collider.xbound.x <= obj2.collider.xbound.y && obj1.collider.xbound.y >= obj2.collider.xbound.x) && 
    (obj1.collider.ybound.x <= obj2.collider.ybound.y && obj1.collider.ybound.y >= obj2.collider.ybound.x) && 
    (obj1.collider.zbound.x <= obj2.collider.zbound.y && obj1.collider.zbound.y >= obj2.collider.zbound.x);
}